use ladder_rs::{
    glicko::{Glicko2Rating, Glicko2, Glicko2TeamRating},
...
fn debug_glicko2_behavior() {
    ...
    println!("Before: P1 μ={}, RD={}, σ={}", player1.mu, player1.rd, player1.volatility);
    println!("Before: P2 μ={}, RD={}, σ={}", player2.mu, player2.rd, player2.volatility);
    ...
    println!("After: P1 μ={:.3}, RD={:.3}, σ={:.6}", new_player1.mu, new_player1.rd, new_player1.volatility);
    println!("After: P2 μ={:.3}, RD={:.3}, σ={:.6}", new_player2.mu, new_player2.rd, new_player2.volatility);
}
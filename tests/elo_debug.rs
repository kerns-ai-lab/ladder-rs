...
fn debug_elo_behavior() {
    ...
    println!("Initial ratings: P1={}, P2={}", player1.rating(), player2.rating());
    ...
    for i in 0..5 {
        ...
        println!("Game {}: P1={:.3}, P2={:.3}", i+1, player1.rating(), player2.rating());
    }
    ...
    let quality = system.calculate_match_quality(&[extreme1, extreme2]).unwrap();

...
fn test_trueskill_basic_update_simplified() {
    ...
    println!("Simplified - Winner: μ={:.3}, σ²={:.3}", winner_rating.mean(), winner_rating.variance());
    println!("Simplified - Loser: μ={:.3}, σ²={:.3}", loser_rating.mean(), loser_rating.variance());
...
fn test_trueskill_draw_simplified() {
    ...
    println!("Simplified Draw - Player 1: μ={:.3}, σ²={:.3}", player1_rating.mean(), player1_rating.variance());
    println!("Simplified Draw - Player 2: μ={:.3}, σ²={:.3}", player2_rating.mean(), player2_rating.variance());

...
fn test_register_player() {
    ...
    let profile = manager
        .register_player("player1".to_string(), Some("Alice".to_string()), None)
        .unwrap();
...
fn test_register_duplicate_player() {
    ...
    manager
        .register_player("player1".to_string(), None, None)
        .unwrap();
...
fn test_add_match_record() {
    ...
    manager
        ...
        .unwrap();
    manager
        .register_player("player2".to_string(), None, None)
        .unwrap();
...
fn test_get_player_match_history() {
    ...
    let history = manager
        .get_player_match_history("player1", None, None)
        .unwrap();
...
fn test_get_active_players() {
    ...
    manager
        ...
        .unwrap();
    manager
        .register_player("player3".to_string(), None, None)
        .unwrap();
...
fn test_search_players() {
    ...
    manager
        .register_player("bob456".to_string(), Some("Bob Jones".to_string()), None)
        .unwrap();
...
fn test_export_players() {
    ...
    manager
        .register_player("player2".to_string(), Some("Bob".to_string()), None)
        .unwrap();
...
fn test_get_player_head_to_head() {
    ...
    let h2h = manager
        .get_player_head_to_head("player1", "player2")
        .unwrap();
...
fn test_merge_duplicate_players() {
    ...
    manager
        .register_player("alice_old".to_string(), Some("Alice".to_string()), None)
        .unwrap();
    ...
    manager
        .register_player("opponent".to_string(), None, None)
        .unwrap();
    manager
        .add_match_record(
    ...
    let history = manager
        .get_player_match_history("alice_new", None, None)
        .unwrap();
